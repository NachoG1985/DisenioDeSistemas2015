	...
	<div class="row">
			...
			<div class="panel panel-primary" style="position:fixed">
				...
				<form id="registro" action="../Logica/filtrarRecetas.jsp" method="POST" class="form-horizontal ">
							...
							<div class="form-group">
								...
								<div class="row">
									<div class="col-md-6">
										<input type="number" min="0" max="10000" step="0.01" class="form-control center-block " name="CaloriasMin" placeholder="Calor�as M�nimas">
									</div>
									<div class="col-md-6">
										<input type="number"  min="0" max="10000" step="0.01" class="form-control center-block " name="CaloriasMax" placeholder="Calor�as M�ximas">
									</div>
								</div>
								<input type="number" min="1" max="5" class="form-control center-block " name="calificacion" placeholder="Calificaci�n" disabled>
		...
		if(recetasFiltradas != null)
		{
			...
			while(it.hasNext())
			{
				...
				out.println("<h5 >Calor�as: " + aux.getCaloriasTotales() + "</h5>");
